...
本轮只处理 `01_raw/DeepCas12a_2026` 和论文 PDF `/Users/linzibo/Downloads/s12864-026-13003-3_reference.pdf`。`01_raw` 未被修改；没有训练模型；没有把 DeepCas12a 与 EasyDesign 或任何 diagnostic activity 数据合并。
