...
- Table S5 target window 方法统计：{"source_defined_10nt_flank_window": 1337, "best_match_fallback": 21}。
- Table S5 DNA context 长度统计：{"45": 1337, "42": 10, "36": 8, "44": 3}。
- Table S5 target window 起点统计：{"10": 1339, "7": 8, "1": 8, "9": 3}。
