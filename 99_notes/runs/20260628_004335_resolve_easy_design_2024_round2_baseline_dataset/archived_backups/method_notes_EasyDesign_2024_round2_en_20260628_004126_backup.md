...
Each Table S5 45-nt DNA context was programmatically mapped to the best-matching 25-nt target window against the crRNA. Only basic sequence features were computed; no model was trained.
