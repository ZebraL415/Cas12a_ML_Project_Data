...
## Output Data
- `EasyDesign_2024_diagnostic_activity_v0.csv`: 11992 rows, containing the Table S3 primary internal baseline and the Table S5 external paper test.
- `EasyDesign_2024_diagnostic_activity_feature_table_v0.csv`: 11992 rows, containing basic sequence features.
- `EasyDesign_2024_diagnostic_activity_augmented_optional_v0.csv`: 31993 rows, containing the Table S4 optional augmentation.
